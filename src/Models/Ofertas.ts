...
export default class extends ModelSingleton {
  ...
  static cargarProductosDeOferta(
    ...
    new LoopProperties(oferta.products,
      (ix2: number, prodOferGuar: any, looperProds: LoopProperties) => {
  ...
  static cargarSoloCorrectasFrom(ofertas: any, callbackOk: (ofertasCorrectas: any) => void) {
    ...
    new LoopProperties(ofertas, (ix: number, ofertaGuardada: any, looperOferGuar: LoopProperties) => {
    ...
    // guardadas.forEach((ofertaGuardada: any) => {
    //   // console.log("ofertaGuardada", ofertaGuardada)

    //   var prodsProcesados = 0
    //   const prodsAProcesar = ofertaGuardada.products
    //   if (ofertaGuardada.monto > 0
    //     && prodsAProcesar > 0
    //     && ofertaGuardada.products[0].codbarra != "string") {
